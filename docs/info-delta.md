---
title: "InfoDelta — How deltas work"
hide:
  - toc
---

<style>
  /* The page uses the standalone HTML in an iframe — hide the auto-generated H1 */
...
<p style="margin: 1.2rem 0 0.6rem 0;">
  ...
  <span style="margin-left:0.6rem;color:var(--md-default-fg-color--light);font-size:0.9rem;">key takeaways from Prof. Edward Anthony's lecture, plus context on deltas and climate change.</span>
</p>

<iframe
  id="info-delta-iframe"
  src="../assets/info-delta.html"
  title="InfoDelta — How deltas work (interactive version)"
  scrolling="no"
